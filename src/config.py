...
def print_banner() -> None:
    ...
    print(COLOR_CODE["CYAN"]+ "SHOW-META FREEE")
    print(F'{COLOR_CODE["DARK"]}{COLOR_CODE["BOLD"]}\n* Разработчик: {COLOR_CODE["RESET"]}{COLOR_CODE["PINK"]}{GLOBAL_SOFT_INFO["AUTHOR"]}{COLOR_CODE["RESET"]}')
    print(F'{COLOR_CODE["DARK"]}{COLOR_CODE["BOLD"]}* Мы в Телеграме: {COLOR_CODE["RESET"]}{COLOR_CODE["LI_G"]}{GLOBAL_SOFT_INFO["SOFT_ORIGINAL_CHANNEL"]}{COLOR_CODE["RESET"]}')
    print(F'{COLOR_CODE["DARK"]}{COLOR_CODE["BOLD"]}* Оригинальная ссылка: {COLOR_CODE["RESET"]}{COLOR_CODE["LI_G"]}{GLOBAL_SOFT_INFO["SOFT_ORIGINAL_LINK"]}{COLOR_CODE["RESET"]}')
    print(F'{COLOR_CODE["DARK"]}{COLOR_CODE["BOLD"]}* Совет от нас: {COLOR_CODE["RESET"]}{COLOR_CODE["LI_G"]}Воспользуйтесь пунктом 2.{COLOR_CODE["RESET"]}')
    print(F'{COLOR_CODE["RED"]}*––––––––––––––––––—————* V {GLOBAL_SOFT_INFO["SOFT_VERSION"]}{COLOR_CODE["RESET"]} *—BETA————*\n')
